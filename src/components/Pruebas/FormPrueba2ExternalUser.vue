<template>
    <div class="m-3">
        <b-form @submit="onSubmit" @reset="onReset" v-if="show">
            ...
            <div>
                <video
                    src="../../assets/videos_ex/AMARILLO_EX.mp4"
                    controls
                    width="300"
                    height="300"
                ></video>
            ...
            <div>
                <video
                    src="../../assets/videos_ex/AZUL_EX.mp4"
                    controls
                    width="300"
                    height="300"
                ></video>
            ...
            <div>
                <video
                    src="../../assets/videos_ex/EL_EX.mp4"
                    controls
                    width="300"
                    height="300"
                ></video>
            ...
            <div>
                <video
                    src="../../assets/videos_ex/ELLA_EX.mp4"
                    controls
                    width="300"
                    height="300"
                ></video>
            ...
            <div>
                <video
                    src="../../assets/videos_ex/ROJO_EX.mp4"
                    controls
                    width="300"
                    height="300"
                ></video>
    ...
    methods: {
        async onSubmit(event) {
            ...
            const sendResult = await requestHandler
                .async_fetch(
                    `${process.env.VUE_APP_BACKEND}/api/v1/evaluacion/respuestasExternalUsers`,
